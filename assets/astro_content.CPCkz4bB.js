import { f as objectType, g as dateType, h as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, i as escape, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, r as renderComponent } from './astro/server.BcuEOnZl.js';
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path.DTYIW6kp.js';
import { V as VALID_INPUT_FORMATS } from './consts.BmVDRGlB.js';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./astro_data-layer-content.vfULw8XH.js');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/./", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://kosmopos.co", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./astro_assets.B77CA0z6.js').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules.CV-6-T5K.js');
